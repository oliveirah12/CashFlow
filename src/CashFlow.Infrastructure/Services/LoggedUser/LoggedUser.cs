...
public class LoggedUser : ILoggedUser
{
    ...
    public async Task<User> Get()
    {
        ...
        var userIdentifierClaim = jwtSecurityToken.Claims.First(claim => claim.Type == ClaimTypes.Sid).Value;

        return await _dbContext
            .Users
            .AsNoTracking()
            .FirstAsync(user => user.UserIdentifier == Guid.Parse(userIdentifierClaim));
    }
}
